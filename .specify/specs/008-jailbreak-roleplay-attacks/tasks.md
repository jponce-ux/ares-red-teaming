...
- [x] T002 Create jailbreak/role-play category module path in `ares/src/attacks/categories/`

## Phase 2: User Story 1 - Run Jailbreak/Role-Play Variants (P1)

- [x] T003 [TDD-RED] Add fixture validation tests in `ares/tests/jailbreak_roleplay_attacks.rs`
- [x] T004 [TDD-RED] Add controlled execution tests with mocked ENDI adapter in `ares/tests/jailbreak_roleplay_attacks.rs`
- [x] T005 [US1] Create three to five jailbreak/role-play variants in `ares/fixtures/attacks/jailbreak_roleplay.jsonl`
- [x] T006 [TDD-GREEN] Register jailbreak/role-play category loader in `ares/src/attacks/categories/jailbreak_roleplay.rs`
